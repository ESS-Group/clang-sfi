...
{ tail -n +3 $BUILD_DIR/injections/MLAC_0.patch && tail -n +3 $BUILD_DIR/injections/MLAC_1.patch; } | diff $REFERENCE_FILE - >> $OUTPUT_FILE || (echo "Test failed, reference output not given" && exit 1)
